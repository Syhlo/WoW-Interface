...
|cffffff00點一下:|r 取得你的獎勵!]=],
	...
	["koKR"] = {
		...
		localeContent = {
	["SL_ABOUT"] = "소개",
	["SL_ABOUT_TEXT"] = "이 애드온은 Ellypse의 Patreon (|cffcccccchttp://patreon.com/Ellypse|r) 후원자의 지원으로 유지 및 업데이트되고 있습니다: %s",
	["SL_ACCEPTANCE"] = "알겠습니다.",
	["SL_BYPASS_NPC"] = "이 NPC의 잡담 무시",
	["SL_BYPASS_NPC_TT"] = "이 NPC를 기억해 주요 기능을 바로 이용할 수 있도록 잡담을 무시합니다. 상인, 비행 조련사 또는 자주 상호작용할 때 유용합니다.",
	...
	["SL_CONFIG_DIALOG_CHOICES"] = "대화 선택지",
	["SL_CONFIG_DIALOG_TEXT"] = "대화 본문",
	["SL_CONFIG_DISABLE_IN_DMF"] = "다크문 섬에서 스토리라인 비활성화",
	["SL_CONFIG_DISABLE_IN_DMF_TT"] = "다크문 섬에 입장하면 자동적으로 스토리라인을 비활성화합니다.",
...
스토리라인 제작진의 트위터, |cff55acee@EllypseCelwe|r 와 |cff55acee@Telkostrasz|r를 팔로우하시고 스토리라인의 새로운 소식을 알아보세요.
	...
	["SL_STORYLINE"] = "스토리라인",
	["TUTORIAL_DIALOG_SCROLL"] = "대화문 선택지가 많을 때, 아래쪽 테두리를 반짝이게 하여 더 많은 선택지가 있음을 나타냅니다.",
	["TUTORIAL_REWARD_CHOICES"] = "이 퀘스트에서는 보상을 선택할 수 있습니다. 받고 싶은 보상을 클릭하십시오. 당신은 %s의 착용 모습을 미리 보거나 %s의 채팅 링크를 만들 수 있습니다."
}
