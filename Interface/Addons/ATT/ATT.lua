...
local dbVisibility = {{
    ...
    ["ability"] = "dungeons",
    ["sname"] = "Show in Dungeons"
}, {
    ["ability"] = "scenarios",
    ["sname"] = "Show in Scenarios"
}, {
    ["ability"] = "inbg",
    ["sname"] = "Show in Battleground"
}, {
    ["ability"] = "inraid",
    ["sname"] = "Show in Raid Instance"
}, {
    ["ability"] = "outside",
    ["sname"] = "Show in Open World"
}}
...
local supportedRaidUnits = {"raid1", "raid2", "raid3", "raid4", "raid5", "raid6", "raid7", "raid8", "raid9", "raid10", "raid11", "raid12", "raid13", "raid14", "raid15", "raid16", "raid17", "raid18", "raid19", "raid20", "raid21", "raid22", "raid23",
                            "raid24", "raid25", "raid26", "raid27", "raid28", "raid29", "raid30", "raid31", "raid32", "raid33", "raid34", "raid35", "raid36", "raid37", "raid38", "raid39", "raid40"}
...
function ATT:EnqueueInspect(grupdate)
    ...
    if grupdate and #inspect_queue > 0 and C_PvP.GetActiveMatchDuration() < 5 then
...
function ATT:ProcessInspectQueue()
    for i, guid in pairs(inspect_queue) do
        ...
        if unit and (not UnitIsConnected(unit) or (insUnitDelay[guid] and insUnitDelay[guid] > GetTime() + 120)) then
            self:DequeueInspectByGUID(guid)
        end
...
function ATT:INSPECT_READY(guid)
    ...
    if unit and guid and self.isATTunit and self.isATTunit == guid then
        ...
        ATTInspectedCheck:SetInventoryItem(unit, 16, 1)
...
local customframes = {
    [3] = {
        ctype = "ShadowUFRaidGR",
        cname = "ShadowedUnitFrames",
        cframe = "SUFHeaderraid1RGUnitButton%d"
    },
    [4] = {
        ctype = "ShadowedUF",
        cname = "ShadowedUnitFrames",
        cframe = "SUFHeaderpartyUnitButton%d"
    },
    [5] = {
        ctype = "ShadowUFRaid",
        cname = "ShadowedUnitFrames",
        cframe = "SUFHeaderraidUnitButton%d"
    },
    [6] = {
        ctype = "Grid2",
        cname = "Grid2",
        cframe = "Grid2LayoutHeader1UnitButton%d"
    },
    [7] = {
        ctype = "Nug",
        cname = "Nug",
        cframe = "NugRaid1RGUnitButton%d"
    },
    [8] = {
        ctype = "HealBot",
        cname = "HealBot",
        cframe = "HealBot_Action_HealUnit%d"
    },
    [9] = {
        ctype = "InvenRaidFrames3",
        cname = "InvenRaidFrames3",
        cframe = "InvenRaidFrame3Group0UnitButton%d"
    },
    [10] = {
        ctype = "Plexus",
        cname = "Plexus",
        cframe = "PlexusLayoutHeader1UnitButton%d"
    },
    [11] = {
        ctype = "ZPerl",
        cname = "ZPerl",
        cframe = "XPerl_party%d"
    },
    [12] = {
        ctype = "ZPerl_RaidGR",
        cname = "ZPerl",
        cframe = "XPerl_Raid_Grp1RGUnitButton%d"
    },
    [13] = {
        ctype = "ElvUI",
        cname = "ElvUI",
        cframe = "ElvUF_PartyGroup1UnitButton%d"
    },
    [14] = {
        ctype = "ElvUIRaidGR",
        cname = "ElvUI",
        cframe = "ElvUF_RaidGroup1RGUnitButton%d"
    },
    [15] = {
        ctype = "VuhDo",
        cname = "VuhDo",
    ...
    [16] = {
        ctype = "Tukui",
        cname = "Tukui",
        cframe = "TukuiPartyUnitButton%d"
    },
    [17] = {
        ctype = "Duf",
        cname = "Duf",
        cframe = "DUF_PartyFrame%d"
    },
    [18] = {
        ctype = "PitBull4",
        cname = "PitBull4",
        cframe = "PitBull4_Groups_PartyUnitButton%d"
    },
    [19] = {
        ctype = "ShestakUI_DPS",
        cname = "ShestakUIDPS",
        cframe = "oUF_PartyDPSUnitButton%d"
    },
    [20] = {
        ctype = "ShestakUI",
        cname = "ShestakUI",
        cframe = "oUF_PartyUnitButton%d"
    },
    [21] = {
        ctype = "KkthnxUI",
        cname = "KkthnxUI",
    ...
    [23] = {
        ctype = "RUF",
        cname = "RUF",
        cframe = "oUF_RUF_PartyUnitButton%d"
    },
    [24] = {
        ctype = "GwRaid",
        cname = "Gw",
        cframe = "GwRaidGridDisplay%d"
    },
    [25] = {
        ctype = "Gw",
        cname = "Gw",
        cframe = "GwCompactparty%d"
    },
    [26] = {
        ctype = "Lime_Party",
        cname = "Lime",
        cframe = "LimeGroup0UnitButton%d"
    },
    [27] = {
        ctype = "Cell",
        cname = "Cell",
        cframe = "CellPartyFrameMember%d"
    },
    [28] = {
        ctype = "CellRaid",
        cname = "Cell",
        cframe = "CellRaidFrameMember%d"
    },
    [29] = {
        ctype = "Grid2_Group",
        cname = "Cell",
        cframe = "Grid2LayoutHeader1RGUnitButton%d"
    },
    [30] = {
        ctype = "AshToAsh",
        cname = "AshToAsh",
        cframe = "AshToAshUnit1RGUnit%d"
    },
    [31] = {
        ctype = "NDui-RaidGR",
        cname = "NDui",
        cframe = "oUF_Raid1GRUnitButton%d"
    },
    [32] = {
        ctype = "AltzUI",
        cname = "AltzUI",
        cframe = "Altz_PartyUnitButton%d"
    },
    [33] = {
        ctype = "AltzUI-Healer",
        cname = "AltzUI",
        cframe = "Altz_HealerRaidUnitButton%d"
    },
    [34] = {
        ctype = "AltzUI-DPS",
        cname = "AltzUI",
        cframe = "Altz_DpsRaidUnitButton%d"
    },
    [35] = {
        ctype = "ShestakUI_Heal",
        cname = "ShestakUI",
        cframe = "oUF_RaidHeal1RGUnitButton%d"
    },
    [36] = {
        ctype = "GW2",
        cname = "GW2_UI",
        cframe = "GwCompactPartyFrame%d"
    },
    [37] = {
        ctype = "Gw2_Raid",
        cname = "GW2_UI",
        cframe = "GwCompactRaidFrame%d"
    },
    [38] = {
        ctype = "Gw2_Party",
        cname = "GW2_UI",
        cframe = "GwPartyFrame%d"
    }
}
...
function ATT:FindFrames()
    ...
    if isGrouped then
        ...
        if frametype == "PartyMemberFrame%d" then
...
local function CreateIcon(anchor)
    ...
    icon.Start = function(sentCD, nextcharge, rate)
        ...
        if icon.ability and icon.abilityID and nextcharge ~= 5 then
            if anchor.spec and db.alertCD[anchor.spec][icon.abilityID] then
...
function ATT:InspectCovenant()
    ...
    if not soulbindData or not covenantData then
        return
    end

    local pguid = PlayerGUID
    local _, class = UnitClass("player")
    local convActive = nil
    dbCovenant[pguid] = {}
    dbConduit[pguid] = {}
    ...
    for abilityIndex, abilityTable in pairs(self:MergeTable(class, "COVENANT")) do
        ...
        if isKnown then
            ...
            if cooldownMS == 0 then
                _, _, _, cooldownMS = GetSpellCharges(id)
            end
            ...
            if dbCovFix[id] then
                dbCovenant[pguid][dbCovFix[id]] = tonumber(cooldownMS)
            end
        end
    end
                    ...
                    if isConduit then
                        ...
                        for i = 1, 3 do
                            if isConduit.mod[i] and not dbConduit[pguid][isConduit.mod[i]] then
                                if cdmodif and socketEnhanced then
                                    cdmodif = cdmodif + 2
                                end
                                if not cdmodif then
                                    cdmodif = 0
...
function ATT:SendCovenant(pguid)
    if self.useCrossAddonCommunication and IsInGroup() and dbCovenant[pguid] and dbConduit[pguid] then
        ...
        for id, cooldownMS in pairs(dbCovenant[pguid]) do
            C_ChatInfo.SendAddonMessage(ChatPrefix, strjoin("||", "Covenant," .. pguid .. "," .. id .. "," .. cooldownMS .. "," .. covnum),
        ...
        for id, cooldownMS in pairs(dbConduit[pguid]) do
            C_ChatInfo.SendAddonMessage(ChatPrefix, strjoin("||", "Conduit," .. pguid .. "," .. id .. "," .. cooldownMS .. "," .. connum),
                (IsInGroup(LE_PARTY_CATEGORY_INSTANCE) and "INSTANCE_CHAT") or (IsInRaid(LE_PARTY_CATEGORY_HOME) and "RAID") or "PARTY")
            connum = connum + 1
        end
...
function ATT:GetCovenant(unit, guid, stype, id, cooldownMS, num)
    ...
    if stype == "Covenant" and num then
        if num == 1 or type(dbCovenant[guid]) ~= "table" then
            dbCovenant[guid] = {}
        end
        if dbCovenant[guid] and id then
            dbCovenant[guid][id] = cooldownMS or 0
        end
    end

    if stype == "Conduit" and num then
        if num == 1 or type(dbConduit[guid]) ~= "table" then
            dbConduit[guid] = {}
        end
        if dbConduit[guid] and id then
            dbConduit[guid][id] = cooldownMS or 0
        end
    end
...
function ATT:UpdateAnchorGUID(unit, guid, specInspect)
    ...
    if specInspect and specInspect ~= "0" and specInspect ~= "nil" and class then
        ...
        for k = 1, 3 do
            _, _, _, _, _, abilityTid = GetPvpTalentInfoByID((isInspect and GetInspectSelectedPvpTalent(unit, k) or C_SpecializationInfo.GetAllSelectedPvpTalentIDs()[k]) or 0)
            if ATTAnchor.isPVP and abilityTid then
                dbInspect[guid][abilityTid] = 1
            end
        end
        ...
        for i = 1, #TreeIDs do
            for _, NodeID in pairs(C_Traits.GetTreeNodes(TreeIDs[i])) do
                ...
                if (activeEntry and activeRank > 0) then
                    ...
                    if spellID then
                      if ATTdbs.dbMergedSpell[spellID] then spellID = ATTdbs.dbMergedSpell[spellID] end
    ...
    for abilityIndex, abilityTable in pairs(dbRacial) do
        ...
        if raceID ~= race or not db.isEnabledRacial[id] then
            ability = nil
        end
    ...
    for abilityIndex, abilityTable in pairs(dbExtraTrinkets) do
        local ability, id, cooldown, sname = abilityTable.ability, abilityTable.id, abilityTable.cooldown, abilityTable.sname
        if (id ~= item1 and id ~= item2) or not db.isEnabledTrinkets[sname] then
            ability = nil
        end
    ...
    if dbCovenant[guid] and spec and spec ~= "0" and spec ~= "nil" and type(db.isEnabledSpell[spec] == "table") then
        for abilityIndex, abilityTable in pairs(dbImport[class]["COVENANT"]) do
            ...
            local covenant = ATTAnchor.isConvEnabled and dbCovenant[guid][id]
            local conduit = ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][id]
            local modif2 = dbModif2[id]

            if not db.isEnabledSpell[spec][id] or not covenant then
                ability = nil
            end
           
            if ability and ATTdbs.dbLegeModif[id] and dbInspect[guid]["legeinfo"][ATTdbs.dbLegeModif[id].lege] then
                cooldown = cooldown - ATTdbs.dbLegeModif[id].cooldown
            end
            
            if ability and modif2 and dbInspected[modif2.mod] == 1 then --fix if talents
                cooldown = (modif2.x and cooldown * modif2.cooldown) or (cooldown - modif2.cooldown);
            end
            
            if ability and conduit then
                cooldown = (ATTdbs.dbConduitModX[id] and cooldown * conduit) or (cooldown - conduit)
            end
        ...
        for abilityIndex, abilityTable in pairs(self:MergeTable(class, spec)) do
            ...
            if replace then
               for _, replaceid in pairs(replace) do
                if dbInspected[replaceid] then ability = nil end
                end
            end

            if ability and (custom and not db.isEnabledSpell[spec][id .. "custom"]) or (not custom and not db.isEnabledSpell[spec][id]) or dbInspected["not"][id] or (dbisPVPspell[id] and not dbInspected[id]) then
                ability = nil
            end

            if ability and modif and dbInspected[modif.mod] then
            ...
            if ability and modif2 and dbInspected[modif2.mod] == 1 then
                cooldown = (modif2.x and cooldown * modif2.cooldown) or (cooldown - modif2.cooldown);
            end

            if ability and ATTdbs.dbLegeModif[id] and dbInspect[guid]["legeinfo"][ATTdbs.dbLegeModif[id].lege] then
                cooldown = cooldown - ATTdbs.dbLegeModif[id].cooldown
                if ATTAnchor.isPVP and id == 5384 then
                    cooldown = cooldown + 10
                end -- hunter fd lege fix pvp
            end

            if ability and conduit and not (modif and dbInspected[modif.mod]) and not (modif2 and dbInspected[modif2.mod]) then
                cooldown = (ATTdbs.dbConduitModX[id] and cooldown * conduit) or (cooldown - conduit)
            end -- ?
            ...
            if ability and id then
                ...
                icon.texture:SetTexture(self:FindAbilityIcon(ability, id))
                if id == 119898 then
                    lpet = SUMMON .. " " .. tostring(UnitCreatureFamily(gsub(unit, "(%a+)", "%1pet")))
                    if ATTdbs.lockPetChange[lpet] then
                        icon.texture:SetTexture(ATTdbs.lockPetChange[lpet])
                    end
                end -- lockpet
                icon.GUID = anchor.GUID
                icon.ability = ability
                ...
                if dbInspected[dbModifCharge[id]] then
                    if charges then
...
function ATT:UpdateIcons()
    for k, anchor in ipairs(anchors) do
        ...
        elseif guid and (guid == PlayerGUID) and db.showSelf then
            ...
            anchor:Hide()
            anchor:HideIcons()
            if anchor.GUID and dbCovenant[anchor.GUID] and not self:GetUnitByGUID(anchor.GUID) then
                dbCovenant[anchor.GUID] = nil;
                dbConduit[anchor.GUID] = nil;
            end
        end
    end
end
...
function ATT:ApplyAnchorSettings()
    local _, instanceType = IsInInstance()
    ATTAnchor.isPVP = (C_PvP.IsWarModeDesired() and instanceType == "none") or (instanceType == "arena") or (instanceType == "pvp")
    ATTAnchor.isConvEnabled = IsUsableSpell(324739) -- workaround covenant disable
...
function ATT:UNIT_AURA(unit, unitAuraUpdateInfo)
    ...
    if not unit or not unitAuraUpdateInfo then
        return
    end
    local guid = UnitGUID(unit)
    ...
    if unitAuraUpdateInfo then
       if unitAuraUpdateInfo.addedAuras ~= nil then
        ...
        if auraInfo.spellId == 5384 or auraInfo.spellId == 6544 then
           self:StartCooldown(GetSpellInfo(auraInfo.spellId), unit, auraInfo.spellId,  dbAuraRemoved[auraInfo.spellId] and "AuraOn")
        end
      end       
...
--]]
    if unitAuraUpdateInfo.removedAuraInstanceIDs ~= nil then
        for _, auraInstanceID in ipairs(unitAuraUpdateInfo.removedAuraInstanceIDs) do
            ...
            if auraInfo and (auraInfo.spellId == 5384 or SentID == 6544) then
               self:StartCooldown(GetSpellInfo(auraInfo.spellId), unit, auraInfo.spellId)
            end
            auras[guid][auraInstanceID] = nil
           -- self:IconGlow(auras[guid][auraInstanceID].sourceUnit, GetSpellInfo(auraInfo.spellId), "SPELL_AURA_REMOVED", unit, auraInfo.spellId)
        end
      end
    end
end
    ...
    if db.dampening and instanceType == "arena" then
        ...
        if percentage then
            ...
            if ATTDampframe.text and ATTDampframe.newpercentage ~= percentage then
                ...
                if not ATTDampframe:IsShown() then
                    ATTDampframe:Show()
                end
            end
        end
...
function ATT:TrackCooldown(anchor, ability, SentID, unit, guid, flag)
    ...
    for k, icon in ipairs(anchor.icons) do
        ...
        if icon.abilityID == 119898 and icon.inUse and ATTdbs.lockPetChange[SentID] then
            icon.Stop();
            icon.texture:SetTexture(ATTdbs.lockPetChange[SentID])
        end -- lock pet change

        local creduce = dbReduce[SentID]
        if creduce and ((creduce.tid and dbInspect[guid][creduce.tid]) or creduce.tid2 == 1) then
            for i = 1, 3 do
                reducecd = nil
                if (type(creduce.mod) == "table" and icon.abilityID == creduce.mod[i]) then
                    local reducecd = creduce.rcooldown
                    if not dbInspect[guid][creduce.tid] then
                        reducecd = creduce.rcooldown2
                    end
                    if creduce.mod[i] == 42650 then
                        reducecd = 5
                    end -- dk army quick fix
                    if creduce.mod[i] == 257044 and not anchor.isTrueshot then
                        reducecd = nil
                    end -- rapid fire fix 288613
                    if creduce.mod[i] == 22842 and not anchor.isRegen then
                        reducecd = nil
                    end -- regen drood fix 50334
                    if spec == 257 and cooldownResetters[200183][icon.abilityID] then -- Hpriest Apotheosis fix
                        if ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][338345] then
                            reducecd = reducecd + (reducecd * dbConduit[guid][338345])
                        end
                        if anchor.isApotheosis then
                            reducecd = reducecd * 4
                        end
                        if anchor.isDivineConversation and icon.abilityID ~= 88625 and cooldownResetters[200183][icon.abilityID] then
                            reducecd = reducecd + (ATTAnchor.isPVP and 10 or 15)
                        end -- Divine Conversation 
                    end
        ...
        if pcheck and dbReducePowerSpell[SentID] and ((pcheck.tid and dbInspect[guid][pcheck.tid]) or pcheck.tid2 == 1) then
            for i = 1, 12 do
                local reducecd = nil
                if (type(pcheck.mod) == "table" and icon.abilityID == pcheck.mod[i]) then
                    if not dbInspect[guid][pcheck.tid] then
                        pcheck.crd = pcheck.crd2
                    end -- selected
                    if spec == 65 or spec == 66 or spec == 70 then
                        reducecd = dbReducePowerSpell[SentID] * pcheck.crd
                    end
                    if spec == 253 or spec == 254 or spec == 255 then
                        reducecd = dbReducePowerSpell[SentID] / pcheck.crd
                    end
                    if spec == 269 then
                        reducecd = dbReducePowerSpell[SentID] / pcheck.crd
                    end
                    if spec == 71 or spec == 72 or spec == 73 then
                        reducecd = dbReducePowerSpell[SentID] / pcheck.crd
                    end
                    if spec == 250 then
                        reducecd = dbReducePowerSpell[SentID] / pcheck.crd
                    ...
                    if spec == 260 or spec == 261 then
                        reducecd = dbReducePowerSpell[SentID] * pcheck.crd
                    end -- to do combo check
                    if spec == 260 and (icon.abilityID == 5277 or icon.abilityID == 1966) and dbInspect[guid][354897] then
                        reducecd = reducecd / 2
                    end -- quick updade
                    if spec == 260 and (icon.abilityID == 5277 or icon.abilityID == 1966) and not dbInspect[guid][354897] then
                        reducecd = nil
                    end
...
function ATT:ReduceCD(unit, SentID, event, timer, hit)
    ...
    if (class == "DEATHKNIGHT") and (event == "SPELL_ENERGIZE") and ATTAnchor.isConvEnabled and type(dbConduit[guid]) == "table" and dbConduit[guid][338553] then -- dk Convocatoin of the Dead conduitcd
        local ccheck = ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][338553]
        for k, icon in ipairs(anchor.icons) do
    ...
    if (class == "MAGE") and (SentID == 342246 or SentID == 325130) then
        ...
        for k, icon in ipairs(anchor.icons) do
            if icon.inUse and SentID == 342246 and icon.abilityID == 1953 and dbInspect[guid][342249] and (event == "SPELL_AURA_REMOVED") then
                icon.Stop()
            end
            if icon.inUse and icon.active and icon.cooldown > 0 and icon.starttime > 0 and SentID == 325130 and (event == "SPELL_CAST_SUCCESS") and not excludeID[icon.abilityID] then
                local reducecd = 2.5
                local ccheck = ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][336992]
                if ccheck then
                    reducecd = reducecd + ccheck
                end
                local starttime = icon.starttime - reducecd * (rate or 1)
                icon.SetTimer(starttime, icon.cooldown, rate)
            end
    ...
    if (class == "WARLOCK") and (event == "barirercov") and ATTAnchor.isConvEnabled and type(dbConduit[guid]) == "table" and timer and hit and dbConduit[guid][339272] then
        local ccheck = ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][339272]
        for k, icon in ipairs(anchor.icons) do
            if ccheck and icon.inUse and icon.active and icon.cooldown > 0 and icon.starttime > 0 and icon.abilityID == 104773 then
                local health = UnitHealthMax(unit)
                if (health and (hit / health) < 0.05) or (icon.barirertimer and icon.barirertimer > timer) then
                    break
                end
    ...
    if (class == "PALADIN") and (event == "buble") and ATTAnchor.isConvEnabled and type(dbConduit[guid]) == "table" and dbConduit[guid][338741] and timer then
        local ccheck = ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][338741]
        for k, icon in ipairs(anchor.icons) do
            if ccheck and icon.inUse and icon.active and icon.cooldown > 0 and icon.starttime > 0 and icon.abilityID == 642 then
                if (icon.bubletimer and icon.bubletimer > timer) then
                    break
                end
    ...
    if (class == "PRIEST") and (event == "voidform") and dbInspect[guid][199259] and timer then
        for k, icon in ipairs(anchor.icons) do
    ...
    if SentID == 633 and (event == "SPELL_HEAL") and dbInspect[guid][326734] and timer then
        for k, icon in ipairs(anchor.icons) do
    ...
    if SentID == 119996 and (event == "SPELL_CAST_SUCCESS") and dbInspect[guid][353584] then
    ...
    if (class == "ROGUE") and (event == "DODGE") and ATTAnchor.isConvEnabled and type(dbConduit[guid]) == "table" and dbConduit[guid][341535] and timer then
        local ccheck = ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][341535]
        for k, icon in ipairs(anchor.icons) do
            if ccheck and icon.inUse and icon.active and icon.cooldown > 0 and icon.starttime > 0 and icon.abilityID == 5277 then
                if (icon.dogetimer and icon.dogetimer > timer) then
                    break
                end
    ...
    if (class == "MONK") and (SendID == 115151 or SendID == 322101 or SendID == 124682 or SendID == 116670) and (event == "SPELL_CAST_SUCCESS") and ATTAnchor.isConvEnabled and type(dbConduit[guid]) == "table" and dbConduit[guid][336773] then -- monk Jade Bond
        local cdList = {
            [322118] = true,
            [325197] = true
        }
        local ccheck = ATTAnchor.isConvEnabled and dbConduit[guid] and dbConduit[guid][336773]
        for k, icon in ipairs(anchor.icons) do
    ...
    if (class == "ROGUE") and SendID == 36554 and (event == "SPELL_CAST_SUCCESS") and dbInspect[guid][200209] then
        for k, icon in ipairs(anchor.icons) do
            if icon.inUse and icon.active and icon.cooldown > 0 and icon.starttime > 0 and icon.abilityID == 36554 then
                C_Timer.After(0.1, function()
                    icon.SetTimer(GetTime() - 40, icon.cooldown, rate)
                end)
            end
        end
    end
        ...
        for k, icon in ipairs(anchor.icons) do
            if lreduce and dbInspect[guid]["legeinfo"] and dbInspect[guid]["legeinfo"][lreduce.lege] and icon.inUse and icon.active and icon.cooldown > 0 and icon.starttime > 0 then
                if icon.abilityID == 108280 or icon.abilityID == 198067 or icon.abilityID == 192249 then
                    if (icon.damagetimer and icon.damagetimer > timer) then
                        break
                    end
                    icon.damagetimer = timer + 0.1
                    local cdlreduce = ATTdbs.dbLegeReduce[SentID].cooldown
                    if icon.abilityID == 108280 then
                        cdlreduce = cdlreduce - 2
                    end
                    if icon.abilityID == 198067 or icon.abilityID == 192249 then
                        cdlreduce = cdlreduce - 1
                    end
    ...
    if ((class == "MONK") or (class == "DRUID")) and (event == "SPELL_CAST_SUCCESS") then
        local lreduce = ATTdbs.dbLegeReduce[SentID]
        if lreduce and dbInspect[guid]["legeinfo"] and dbInspect[guid]["legeinfo"][lreduce.lege] then
            reduce = lreduce
        end
    end
    ...
    if (event == "SPELL_DAMAGE") and (class == "MAGE") then
        if dbInspect[guid][ATTdbs.dbModifCrit[SentID].tid] then
            reduce = ATTdbs.dbModifCrit[SentID]
        end
    end

    if (event == "SPELL_INTERRUPT") and ATTdbs.dbModKick[SentID] then
        if dbInspect[guid][ATTdbs.dbModKick[SentID].tid] then
            reduce = ATTdbs.dbModKick[SentID]
        end
        if ATTAnchor.isConvEnabled and type(dbConduit[guid]) == "table" and dbConduit[guid][ATTdbs.dbModKick[SentID].tid] then
            reduce = ATTdbs.dbModKick[SentID]
        end
    end
    ...
    if (class == "PALADIN") and (event == "SPELL_CAST_SUCCESS") then
        ...
        if ATTdbs.dbReducePowerSpell[SentID] and lreduce and dbInspect[guid]["legeinfo"] and dbInspect[guid]["legeinfo"][lreduce.lege] then
            reduce = lreduce
        end
        if spec == 66 and dbInspect[guid][204074] then
            reduce = {
                ["mod"] = {
                    [1] = 31884,
                    [2] = 86659
        ...
        for i = 1, 5 do
            if reduce and reduce.mod and icon.abilityID == reduce.mod[i] and reduce.cooldown then
                if icon.inUse and icon.active and icon.cooldown > 0 and icon.starttime > 0 then
                    ...
                    if (class == "PALADIN") and dbReducePowerSpell[SentID] then
                        reducecd = reduce.cooldown * dbReducePowerSpell[SentID]
                    end
                    local starttime = icon.starttime - reducecd * (rate or 1)
                    icon.SetTimer(starttime, icon.cooldown, rate)
                end
...
function ATT:PredictCovn(sourceGUID, unit, SentID, spellName) -- here
    if not self:CheckValidUnit(unit) or not dbInspect[sourceGUID] then
        return
    end
    local unitSpec = tostring(dbInspect[sourceGUID]["spec"])
    local _, class = UnitClass(unit)

    if not unitSpec or unitSpec == "0" or unitSpec == "nil" or not class or type(db.isEnabledSpell[unitSpec]) ~= "table" then
        return
    end
    local isConvSpell = db.isEnabledSpell[unitSpec][SentID] and self:FindAbilityByName(dbImport[class]["COVENANT"], SentID)
    if isConvSpell then
        if type(dbCovenant[sourceGUID]) ~= "table" then
            dbCovenant[sourceGUID] = {}
        end
    ...
    if unitSpec and unitSpec == 257 then
        if SentID == 363727 then
            if (event == "SPELL_AURA_REMOVED") then
                anchor.isDivineConversation = nil
            end
            if (event == "SPELL_AURA_APPLIED") then
                anchor.isDivineConversation = true
            end
        end
...
function ATT:COMBAT_LOG_EVENT_UNFILTERED()
    ...
    local _, event, _, sourceGUID, sourceName, _, _, destGUID, destName, _, _, SentID, spellName, _, auraType, overheal, powerType, _, currentPower, _, crit = CombatLogGetCurrentEventInfo()
    local unit = self:GetUnitByGUID(sourceGUID)
    local unitDest = self:GetUnitByGUID(destGUID)
    if ATTdbs.dbMergedSpell[SentID] then SentID = ATTdbs.dbMergedSpell[SentID] end
    if unit and (event == "SPELL_CAST_SUCCESS") then
     if SentID then
            self:PredictCovn(sourceGUID, unit, SentID, spellName)
        end -- predict conv
        self:StartCooldown(spellName, unit, SentID, dbAuraRemoved[SentID] and "AuraOn")
        self:ReduceCD(unit, SentID, event)
        if (SentID == 204366 or SentID == 329042) then
        ...
        if SendID == 36554 and unitDest then
            self:ReduceCD(unit, SentID, event)
        end
        if (SendID == 115151 or SendID == 322101 or SendID == 124682 or SendID == 116670 or SentID == 119996) then
            self:ReduceCD(unit, SentID, event)
        end -- monk condu or port
    end
    ...
    if unit and (event == "SPELL_AURA_REMOVED") and (auraType == "BUFF") then
        ...
        if SentID == 342246 or SentID == 47788 then
            self:ReduceCD(unit, SentID, event)
        end
        if SentID == 204366 or SentID == 327710 or SentID == 328622 or SentID == 329042 then
            self:RecoveryCD(unitDest, SentID, event, unit)
        end
    end

    if unit and ((event == "SPELL_AURA_APPLIED") and (auraType == "BUFF")) then
        if (SentID == 327710 or SentID == 328622) then
            self:RecoveryCD(unitDest, SentID, event)
        end
        if (SentID == 64901 or SentID == 212800 or SentID == 326860) then
            self:ReduceCD(unit, SentID, event)
        end
    end
    ...
    if unit and (event == "SPELL_DAMAGE") and SentID == 328928 then
        self:ReduceCD(unit, SentID, event, GetTime())
    end
    if unit and (event == "SPELL_DISPEL") and SentID == 314793 then
        self:ReduceCD(unit, SentID, event)
    end

    if unit and (event == "SPELL_DAMAGE") and ATTdbs.dbModifCrit[SentID] and crit then
        self:ReduceCD(unit, SentID, event)
    end
    if unit and (event == "SPELL_DAMAGE") and SentID == 190357 then
        self:ReduceCD(unit, SentID, "blizzard")
    end

    if unit and (event == "SPELL_INTERRUPT") and ATTdbs.dbModKick[SentID] then
        self:ReduceCD(unit, SentID, event)
    end
    if unit and (event == "SPELL_HEAL") and SentID == 48153 then
        self:ReduceCD(unit, SentID, event)
    end
    ...
    -- new
    if unit and (event == "SPELL_ENERGIZE") and SentID == 195757 then
        self:ReduceCD(unit, SentID, event)
    end -- dk Convocatoin of the Dead conduitcd
    if unitDest and ((event == "SPELL_AURA_APPLIED") or (event == "SPELL_AURA_REMOVED")) and SentID == 368239 and auraType == "DEBUFF" then
        self:RecoveryCD(unitDest, SentID, event)
    end -- Decrypted Urh Cypher
    ...
    if db.glows then   
        ...
        self:IconGlow(unit, spellName, event, dest, SentID)
        end
    end
end
        ...
        if icon.inUse and event == "SPELL_AURA_APPLIED" and SentID == icon.abilityID and not icon.race then
            ...
            if icon.showing and icon.cooldown and duration and duration > 1 and icon.cooldown > duration then -- here (icon.active or dbAuraRemoved[SentID])
                ...
                C_Timer.After(duration + 0.5, function()
                    local OLDduration = select(5, AuraUtil.FindAuraByName(spellName, unitDest));
...
function ATT:CHAT_MSG_ADDON(prefix, message, dist, sender)
    ...
    if prefix == ChatPrefix then
        ...
        if not vfound then
            stype, guid, id, cooldownMS, num = strmatch(message, "(.-),(.-),(.-),(.-),(.+)")
        end
        ...
        if vfound == "Version" then
            ...
            if vversion and vversion > ATTversion and not ATTnewversion then
            ...
            if stype and unit and guid ~= PlayerGUID then
                self:GetCovenant(unit, guid, stype, tonumber(id), tonumber(cooldownMS), tonumber(num))
            end
        end
    end
end
...
function ATT:PLAYER_SPECIALIZATION_CHANGED(unit)
    ...
    local guid = UnitGUID(unit)
    if db.autoselectprofile and guid and guid == PlayerGUID then
        ATT:CheckProfile();
        ATT:UpdateScrollBar();
    end
    self:InspectPlayer()
...
function ATT:CheckProfile()
    ...
    if selectedDB.autoselectprofile then
        ...
        if spec then
            selectedDB.ProfileSelected = spec
        end
    end
...
local function ATT_OnLoad(self)
   ...
   hooksecurefunc(C_EditMode, "OnEditModeExit", function() ATT:ApplyAnchorSettings(); end)
...
local function CreateListFrame(title, self)
    if iFrame and iFrame:IsShown() then
        iFrame:Hide()
        return
    end
    iFrame = CreateFrame("Frame", "iFrame", self, "TooltipBorderedFrameTemplate");
...
function ATT:CreateOptions()
    ...
    local scale = panel:MakeSlider('name', 'Scale', 'description', 'Adjust the scale of icons', 'minText', 'Min', 'maxText', 'Max', 'minValue', 0.05, 'maxValue', 2, 'step', 0.05, 'default', 1, 'current', tonumber(db.scale) or 1, 'getCurrent',
        function()
            return tonumber(db.scale) or 1
        end, 'setFunc', function(value)
            if value ~= db.scale then
    ...
    scale:SetPoint("TOPLEFT", attach, "TOPLEFT", 20, -80)
    ...
    local raidGroupSize = panel:MakeSlider('name', 'Raid Group Size', 'description', 'Adjust raid group size', 'minText', 'Hide', 'maxText', '40', 'minValue', 0, 'maxValue', 40, 'step', 1, 'default', 0, 'current', tonumber(db.raidGroupSize) or 5,
        'getCurrent', function()
    ...
    local offsetX = panel:MakeSlider('name', 'Anchor Offset X', 'description', 'Adjust anchor position X', 'minText', 'Left', 'maxText', 'Right', 'minValue', -140, 'maxValue', 140, 'step', 1, 'default', 0, 'current', tonumber(db.offsetX) or 0,
        'getCurrent', function()
    ...
    offsetX:SetPoint("TOPLEFT", attach, "TOPLEFT", 20, -125)

    local offsetY = panel:MakeSlider('name', 'Anchor Offset Y', 'description', 'Adjust anchor position Y', 'minText', 'Down', 'maxText', 'Up', 'minValue', -140, 'maxValue', 140, 'step', 1, 'default', 0, 'current', tonumber(db.offsetY) or 0,
        'getCurrent', function()
    ...
    local iconOffsetX = panel:MakeSlider('name', 'Rows spacing', 'description', 'Adjust space between rows', 'minText', '0', 'maxText', '100', 'minValue', 0, 'maxValue', 100, 'step', 1, 'default', 5, 'current', tonumber(db.iconOffsetX) or 5,
        'getCurrent', function()
    ...
    local iconOffsetY = panel:MakeSlider('name', 'Icons spacing', 'description', 'Adjust space between icons', 'minText', '0', 'maxText', '100', 'minValue', 0, 'maxValue', 100, 'step', 1, 'default', 2, 'current', tonumber(db.iconOffsetY) or 2,
        'getCurrent', function()
    ...
    local dampening = panel:MakeToggle('name', 'Show Dampening', 'description', 'Show dampening percent ( % )\nunder remaining time in arena', 'default', false, 'getFunc', function()
        return db.dampening
    end, 'getCurrent', function()
        return db.dampening
    end, 'setFunc', function(value)
        db.dampening = value;
        ATT:UNIT_AURA("player");
        self:Dampening();
    end)
    ...
    cpanel:SetSize(640, 240)
    cpanel:SetPoint("TOP", panel, "TOP", 0, -240)
    ...
    cpanel2:SetSize(640, 45)
    cpanel2:SetPoint("TOP", panel, "TOP", 0, -483)

    local version = panel:CreateFontString(nil, "ARTWORK", "GameFontDisable")
    version:SetText("|cffffff00Version:|r |cff33ff99v" .. ATTversion .. "|r by |cffffff00izy|r |cffFF4500[test v3]|r")
    version:SetPoint("TOPLEFT", panel, "TOPLEFT", 25, -550)

    local contact = panel:CreateFontString(nil, "ARTWORK", "GameFontDisable")
    contact:SetText("[ Contact: curseforge.com/wow/addons/att ]")
    contact:SetPoint("TOPLEFT", panel, "TOPLEFT", 20, -565)
    ...
    for abilityIndex, abilityTable in pairs(self:MergeTable(db.classSelected, db.specSelected)) do
        ...
        if custom then
            ...
            button:SetScript("OnClick", function(self)
                db.isEnabledSpell[db.specSelected][id .. "custom"] = (button:GetChecked() == true and button:GetChecked()) or false;
                ATT:UpdateIcons();
            end)
        else
        ...
        button:SetHitRectInsets(0, -200, 0, 0)

        button:SetScript('OnEnter', function()
            GameTooltip:ClearLines();
            GameTooltip:SetOwner(scrollframe, "ANCHOR_CURSOR")
        ...
        orderbtn:SetScript("OnClick", function(self)
            ...
            local order = panel:MakeSlider('name', 'Icon Order', 'extra', iFrame, 'description', 'Adjust icon order priority', 'minText', '1', 'maxText', '10', 'minValue', 1, 'maxValue', 10, 'step', 1, 'default', 1, 'current',
                tonumber(db.iconOrder[db.specSelected][id]) or 10, 'setFunc', function(value)
                    if value ~= db.iconOrder[db.specSelected][id] then
                        db.iconOrder[db.specSelected][id] = tonumber(string.format("%.1d", value))
                    end
                end, 'currentTextFunc', function(value)
                    return tonumber(string.format("%.1d", value))
                end)
            ...
            local alertCD = panel:MakeToggle('name', 'Sound alert', 'extra', iFrame, 'description', 'Play sound alert when activated', 'default', false, 'getFunc', function()
                return db.alertCD[db.specSelected][id]
            end, 'setFunc', function(value)
                db.alertCD[db.specSelected][id] = value;
            end)
            alertCD:SetPoint("TOP", order, "BOTTOM", -90, -16)

            local alertCDtext = panel:MakeToggle('name', 'Text alert', 'extra', iFrame, 'description', 'Show text alert when activated', 'default', false, 'getFunc', function()
                return db.alertCDtext[db.specSelected][id]
            end, 'setFunc', function(value)
                db.alertCDtext[db.specSelected][id] = value;
            end)
            ...
            updatebtn:SetScript("OnClick", function(self)
                local ordervalue = string.format("%.0f", order.value)
                self:GetParent():Hide()
                ATT:UpdateScrollBar();
                ATT:UpdateIcons()
            end)
...
function ATT:UpdateCovenantScrollBar()
    ...
    for abilityIndex, abilityTable in pairs(self:MergeTable(db.classSelected, "COVENANT")) do
        ...
        if line == 1 then
            button:SetPoint("TOPLEFT", scrollframe2, "TOPLEFT", 2, 0)
        end
        ...
        button:SetScript('OnEnter', function()
            GameTooltip:ClearLines();
            GameTooltip:SetOwner(scrollframe2, "ANCHOR_CURSOR")
            GameTooltip:SetSpellByID(id);
            GameTooltip:AddLine("Spell ID: " .. id, 1, 1, 1);
            GameTooltip:SetPadding(16, 0)
        end)
...
function ATT:CreateAbilityEditor()
    ...
    scrollframe:SetSize(260, 210)
    scrollframe:SetPoint('LEFT', 30, -60)
    
    scrollframe2:SetBackdrop(backdrop)
    scrollframe2:SetBackdropColor(0, 0, 0, 0.50)
    local child2 = CreateFrame("Frame", "ATTScrollFrameChild2", scrollframe2)
    child2:SetSize(1, 1)
    scrollframe2:SetScrollChild(child2)
    self.scrollframe2 = child2
    scrollframe2:SetSize(260, 160)
    scrollframe2:SetPoint("TOPLEFT", scrollframe, "TOPRIGHT", 55, -50)
    ...
    local dropdown = panel:MakeDropDown('name', ' Class', 'description', 'Pick a class', 'values',
        {"WARRIOR", "Warrior", "DEATHKNIGHT", "Deathknight", "PALADIN", "Paladin", "PRIEST", "Priest", "SHAMAN", "Shaman", "DRUID", "Druid", "ROGUE", "Rogue", "MAGE", "Mage", "WARLOCK", "Warlock", "HUNTER", "Hunter", "MONK", "Monk", "DEMONHUNTER",
    ...
    dropdown:SetPoint("TOPLEFT", scrollframe, "TOPRIGHT", 35, -10)
    child.dropdown = dropdown

    local dropdown2 = panel:MakeDropDown('name', ' Specialization', 'description', 'Pick a spec', 'values', {"71", "Arms", "72", "Fury", "73", "Protection"}, 'default', "71", 'current', "71", 'getCurrent', function()
    ...
    local showTrinkets = panel:MakeButton('name', 'PvP Trinkets', 'description', 'Open PvP Trinkets tab', 'newsize', true, 'func', function()
        ...
        local childiF = CreateFrame("Frame", "showTrinketsChild", isFrame)
        childiF:SetSize(1, 1);
        ...
        for abilityIndex, abilityTable in pairs(dbPVPtrinkets) do
            ...
            button:SetHitRectInsets(0, -200, 0, 0)
            button:SetScript("OnClick", function(self)
                db.isEnabledTrinkets[sname] = (button:GetChecked() == true and button:GetChecked()) or false;
                ATT:UpdateIcons();
            end)
            button:SetScript('OnEnter', function()
                GameTooltip:ClearLines();
                GameTooltip:SetOwner(iFrame, "ANCHOR_TOP")
    ...
    showTrinkets:SetPoint("TOPLEFT", panel, "TOPLEFT", 25, -490)

    local showPVETrinket = panel:MakeButton('name', 'PvE Trinkets', 'description', 'Open PvE Trinkets tab', 'newsize', true, 'func', function()
        local title = "PvE Trinkets"
        CreateListFrame(title, panel)
        local isFrame = CreateFrame("ScrollFrame", "showPVETrinket", iFrame, "UIPanelScrollFrameTemplate");
        isFrame:SetSize(225, 160);
        isFrame:SetPoint("TOPLEFT", iFrame, "TOPLEFT", 10, -55)
        ...
        local childiF = CreateFrame("Frame", "showPVETrinketChild", isFrame)
        childiF:SetSize(1, 1);
        isFrame:SetScrollChild(childiF)
        self.isFrame = childiF
        local btn = {}
    ...
    showPVETrinket:SetPoint("LEFT", showTrinkets, "RIGHT", 15, 0)

    local selectRacials = panel:MakeButton('name', 'Racials', 'description', 'Open Racials Tab', 'newsize', true, 'func', function()
        ...
        local childiF = CreateFrame("Frame", "selectRacialsChild", isFrame)
        childiF:SetSize(1, 1);
        isFrame:SetScrollChild(childiF)
        self.isFrame = childiF
        local btn = {}
        ...
        for abilityIndex, abilityTable in pairs(dbRacial) do
            ...
            button:SetHitRectInsets(0, -200, 0, 0)
            button:SetScript("OnClick", function(self)
                db.isEnabledRacial[id] = (button:GetChecked() == true and button:GetChecked()) or false;
                ATT:UpdateIcons();
            end)
            button:SetScript('OnEnter', function()
                GameTooltip:ClearLines();
    ...
    selectRacials:SetPoint("LEFT", showPVETrinket, "RIGHT", 15, 0)

    local customConduit = panel:MakeButton('name', 'Conduits', 'newsize', true, 'description', 'Enable default Class Conduits\n(ONLY for players without ATT)', 'func', function()
        local spectexture = "Interface\\Icons\\ClassIcon_" .. db.classSelected
        local title = "Default Conduits"
        CreateListFrame(title, panel)
        local isFrame = CreateFrame("ScrollFrame", "customConduit", iFrame, "UIPanelScrollFrameTemplate");
        isFrame:SetSize(225, 160);
        isFrame:SetPoint("TOPLEFT", iFrame, "TOPLEFT", 10, -55)
        ...
        local childiF = CreateFrame("Frame", "customConduitChild", isFrame)
        childiF:SetSize(1, 1);
        isFrame:SetScrollChild(childiF)
        self.isFrame = childiF
        ...
        for abilityIndex, abilityTable in pairs(dbConduitMod) do
            ...
            if conduitClass == db.classSelected then
                ...
                button:SetHitRectInsets(0, -200, 0, 0)
                button:SetScript("OnClick", function(self)
                    db.isEnabledCConduit[id] = (button:GetChecked() == true and button:GetChecked()) or false;
                    ATT:UpdateIcons();
                end)
                button:SetScript('OnEnter', function()
                    GameTooltip:ClearLines();
    ...
    customConduit:SetPoint("LEFT", selectRacials, "RIGHT", 15, 0)

    local abilityeditor = panel:MakeButton('name', 'Ability Editor', 'newsize', true, 'description', 'Add, remove, update abilities for selected class / spec', 'func', function()
        local spectexture = "Interface\\Icons\\ClassIcon_" .. db.classSelected
        local _, name, _, icon, _, class = GetSpecializationInfoByID(db.specSelected)
        local title = "Ability Editor"
        CreateListFrame(title, panel)
        local isFrame = CreateFrame("Frame", "abilityeditor", iFrame);
        isFrame:SetSize(225, 160);
        isFrame:SetPoint("TOPLEFT", iFrame, "TOPLEFT", 10, -55)
        ...
        local addbutton = panel:MakeButton('name', 'Add/Update', 'description', "Add / Update ability", 'extra', isFrame, 'func', function()
        ...
        local removebutton = panel:MakeButton('name', 'Remove', 'description', 'Remove ability', 'extra', isFrame, 'func', function()
            local spec = dropdown2.value
            local _ability, _index = ATT:FindAbilityByName(db.customSpells[spec], tonumber(ideditbox:GetText()))
            if _ability and _index then
    ...
    abilityeditor:SetPoint("LEFT", customConduit, "RIGHT", 15, 0)

    local selectVisibility = panel:MakeButton('name', 'Visibility Tab', 'description', 'Open Visibility Tab', 'newsize', true, 'func', function()
        local title = "Visibility Options"
        CreateListFrame(title, panel)
        local isFrame = CreateFrame("ScrollFrame", "ATC", iFrame);
        isFrame:SetSize(225, 180);
        isFrame:SetPoint("TOPLEFT", iFrame, "TOPLEFT", 10, -35)
        local childiF = CreateFrame("Frame", "selectVisibility", isFrame)
        childiF:SetSize(1, 1);
        isFrame:SetScrollChild(childiF)
        self.isFrame = childiF
        local btn = {}
        ...
        for abilityIndex, abilityTable in pairs(dbVisibility) do
            ...
            button:SetScript("OnClick", function(self)
                db.isEnabledVisibility[ability] = (button:GetChecked() == true and button:GetChecked()) or false;
                ATT:ApplyAnchorSettings();
            end)
            btn[#btn + 1] = button
        end
    end)
    selectVisibility:SetPoint("TOPLEFT", panel, "TOPLEFT", 400, -550)

    local showProfiles = panel:MakeButton('name', 'Profiles Tab', 'description', 'Open Profiles tab', 'newsize', true, 'func', function()
        local title = "Profile Options"
        CreateListFrame(title, panel)
        local isFrame = CreateFrame("ScrollFrame", "showProfiles", iFrame);
        isFrame:SetSize(225, 160);
        isFrame:SetPoint("TOPLEFT", iFrame, "TOPLEFT", 10, -35)
        local childiF = CreateFrame("Frame", "showProfilesChild", isFrame)
        childiF:SetSize(1, 1);
        isFrame:SetScrollChild(childiF)
        self.isFrame = childiF

        local selectProfile = panel:MakeDropDown('name', ' Select Profile', 'description', 'Select Profile', 'extra', iFrame, 'values',
            {"DEFAULT", "Default", "TANK", "Tank", "HEALER", "Healer", "DAMAGER", "DPS", "Extra1", "Extra Profie 1", "Extra2", "Extra Profie 2"}, 'default', "DEFAULT", 'getFunc', function()
        ...
        local autoselectprofile = panel:MakeToggle('name', 'Auto Select Profile', 'description', 'Auto select profile based on your current specialization', 'extra', iFrame, 'default', false, 'getFunc', function()
        ...
        local profilebychar = panel:MakeToggle('name', 'Use Characater DB', 'description', 'Settings will be stored for each Charcater and not per Account\n(your UI will be reloaded)', 'extra', iFrame, 'default', false, 'getFunc', function()
            return ATTDB.profilebychar
        end, 'setFunc', function(value)
            ATTDB.profilebychar = value;
            ATT:CheckProfile();
            ATT:UpdateScrollBar();
            ATT:ApplyAnchorSettings();
            panel:UpdateToggle()
        ...
        reset:SetScript('OnEnter', function()
            GameTooltip:ClearLines();
            GameTooltip:SetOwner(reset, "ANCHOR_TOP")
            GameTooltip:SetText("Reset all settings and profiles")
        end)
    ...
    showProfiles:SetPoint("TOPLEFT", panel, "TOPLEFT", 525, -550)
